...
public class ContratoActivity extends AppCompatActivity
    ...
    public ArrayList<Contrato> contratoGridList;


    RecyclerView recyclerViewContrato;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewContrato = findViewById(R.id.rv_contrato_listt);
        listaContratoGrid();
    ...
    private void listaContratoGrid() {

        String JSON_URL = Constants.CONTRATO_LIST;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, JSON_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Type listType = new TypeToken<List<Contrato>>() {
                }.getType();
                contratoGridList = new Gson().fromJson(response, listType);
                setingRecylerView();
    ...
    private void setingRecylerView() {
        ...
        ContratoRecylerViewAdapter contratoRecylerViewAdapter = new ContratoRecylerViewAdapter(contratoGridList, this);

        recyclerViewContrato.setHasFixedSize(false);
        recyclerViewContrato.setLayoutManager(new GridLayoutManager(this, 1));
        recyclerViewContrato.setNestedScrollingEnabled(false);
        recyclerViewContrato.setAdapter(contratoRecylerViewAdapter);
    }
    private void getSearchAgrupacion(String search){
        ...
        if (netwotkOK) {
            ...
            String JSON_URL = Constants.CONYTRATO_SEARCH + search;
            RequestQueue queue = Volley.newRequestQueue(this);
    ...
    private void settingNavDrawer() {
        ...
        loggedInUser = CustomSharedPrefs.getLoggedInUser(ContratoActivity.this);
        ...
        header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (loggedInUser == null) {
                    Intent intentLogin = new Intent(ContratoActivity.this, LoginActivity.class);
                    intentLogin.putExtra(Constants.LOGIN_PREV_ACTIVITY, Constants.LOGIN_PREV_MAIN_ACTIVITY);
                    startActivity(intentLogin);
                } else {
                    Intent intent = new Intent(ContratoActivity.this, ProfileActivity.class);
                ...
                switch (item.getItemId()) {
                   /* case R.id.nav_home:
                    ...
                    case R.id.nav_evento:
                        Intent intentEvento = new Intent(ContratoActivity.this, EventoActivity.class);
                        startActivity(intentEvento);
                        break;

                    case R.id.nav_contrato:
                        Intent intentContrato = new Intent(ContratoActivity.this, ContratoActivity.class);
                        startActivity(intentContrato);
                        break;

                    case R.id.nav_agrupacion:
                        Intent intentAgrupacion = new Intent(ContratoActivity.this, AgrupacionActivity.class);
                        startActivity(intentAgrupacion);
                        break;

                    case R.id.nav_logout:
                        if (loggedInUser != null) {
                            new AlertDialog.Builder(ContratoActivity.this)
                                    ...
                                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int whichButton) {
                                            ...
                                            CustomSharedPrefs.setProfileUrl(ContratoActivity.this, "");
                                            UtilityClass.signOutFB();
                                            UtilityClass.signOutEmail(ContratoActivity.this);
                                            Intent intentLogin = new Intent(ContratoActivity.this, LoginActivity.class);
                                            startActivity(intentLogin);
                                        }
                                    })
