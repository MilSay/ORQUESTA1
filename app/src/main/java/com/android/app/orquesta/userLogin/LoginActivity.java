package com.android.app.orquesta.userLogin;
...
import com.android.app.orquesta.userRegistration.RegisterVeActivity;
...
import com.android.app.orquesta.userRegistration.RegisterActivity;
...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       printKeyHash(this);
        ...
        if (CustomSharedPrefs.getLoggedInUser(LoginActivity.this) == null) {
            ...
            UtilityClass.textViewScaleIconLeft(this, findViewById(R.id.et_login_email), R.drawable.ic_user_fill_black, .5);
    ...
    private boolean validateField(String email, String password) {
        ...
        } else if (password.length() < 3 && !isEmpty(email)) {
            isFieldEmpty = true;
            tvValidationLoginPassword.setVisibility(View.VISIBLE);
    ...
    private void loginResponse(String response) {
        Persona person = new Gson().fromJson(response, Persona.class);
        tvLoginMsg.setVisibility(View.VISIBLE);
        if (person != null) {

            CustomSharedPrefs.setLoggedInUser(LoginActivity.this, person);
